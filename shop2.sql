...
--
-- Хост: localhost
-- Время создания: Июл 31 2018 г., 08:18
...
(14, 'Adriat', 'adriat', 12, 'Adriat', 'Adriat'),
(15, 'test', 'test', 0, 'test', 'test'),
(17, 'тестовая категория 2', 'testovaya-kategoriya-2', 15, 'слова', 'описания');
...
(4, 41, 'st-1.jpg'),
(5, 41, 'st-2.jpg'),
(8, 41, '4ecc270982305034c1cb905e39600840.jpg');
...
(6, 1, '0', '2018-06-11 18:04:12', '2018-07-20 08:09:03', 'EUR', 'Note', NULL),
(9, 1, '2', '2018-06-15 12:57:40', '2018-06-15 14:58:02', 'UAH', 'Note', NULL),
(11, 1, '1', '2018-06-15 13:09:23', '2018-07-20 08:09:14', 'EUR', 'note', 200);
...
(8, 6, 2, 3, 'Casio MQ-24-7BUL (Red)', 61.6),
(9, 6, 3, 1, 'Casio GA-1000-1AER', 352),
(10, 6, 2, 1, 'Casio MQ-24-7BUL', 61.6),
(11, 6, 5, 1, 'Citizen BJ2111-08E', 440),
(19, 9, 2, 1, 'Casio MQ-24-7BUL', 1806),
(20, 9, 5, 1, 'Citizen BJ2111-08E', 12900),
(21, 9, 8, 1, 'Royal London 41040-01', 2322),
(25, 11, 10, 1, 'Royal London 41156-02', 88),
(26, 11, 8, 1, 'Royal London 41040-01', 79.2);
...
(40, 3, 2, 'Test product 1', 'test-product-1', '<p><strong>Test</strong> product 1</p>\r\n', 578, 0, '1', 'Test product 1', 'Test product 1', 'no_image.jpg', '0'),
(41, 17, 3, 'New Test Product 3', 'new-test-product-3', '<p><strong>New </strong>Product 3 content</p>\r\n', 55.41, 60.2, '1', 'New Product 3qq', 'New Product 3qq', 'bb1fd90887c4bf0426d90794c9f12ecd.jpg', '0');
...
(1, 'user', '$2y$10$BektOfiLdUdWvB0a3FWdDOnUb3A9wBg/k5byiKP33plhzr3lU8gUW', 'dimaoag@gmail.com', 'Dmytro', 'Address 1', 'admin'),
(2, 'user1', '$2y$10$vMFfj/7r76MY3fUrsBSMx.9IaAmYEMfUQ12Q9dIwOJBziiAkMmBSm', '1dimaoag@gmail.com', 'Dmytro1', 'Address 1', 'user'),
(3, 'user2', '$2y$10$/9rIaSZPq1Xexe2Qx/YPHOSJ0qIOGdC.tWRZ7DKpRnUHuj7WocCDe', '2dimaoag@gmail.com', 'Dmytro2', 'Address 2', 'user');
...
ALTER TABLE `attribute_product`
  ...
  ADD CONSTRAINT `attribute_product_ibfk_2` FOREIGN KEY (`attr_id`) REFERENCES `attribute_value` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `attribute_value`
--
ALTER TABLE `attribute_value`
  ADD CONSTRAINT `attribute_value_ibfk_1` FOREIGN KEY (`attr_group_id`) REFERENCES `attribute_group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `modification`
  ADD CONSTRAINT `modification_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
